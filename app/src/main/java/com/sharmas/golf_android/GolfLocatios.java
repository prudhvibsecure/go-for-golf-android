...
import com.sharmas.golf_android.adapter.GolfAdapter;
import com.sharmas.golf_android.adapter.NewLoactionsAdapter;
...
public class GolfLocatios  extends AppCompatActivity implements IItemHandler {

    private NewLoactionsAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.title_name)).setText(extras.getString("rname"));
    ...
    private void getData() {
        try {
            ...
            String url = AppSettings.getInstance(this).getPropertyValue("golf_subarea");
            JSONObject object = new JSONObject();
            object.put("rid", extras.getString("rid"));
            //object.put("location", extras.getString("stateName"));
                    ...
                    if (results != null) {
                        ...
                        if (object.has("status") && object.optString("status").equalsIgnoreCase("0")) {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                String sname = jsonobject.getString("location");
                                String sid = jsonobject.getString("locationid");
                            ...
                            adapter = new NewLoactionsAdapter(this, statesList);
