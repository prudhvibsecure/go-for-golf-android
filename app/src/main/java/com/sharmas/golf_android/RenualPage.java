...
public class RenualPage extends AppCompatActivity implements View.OnClickListener {
...
//        });
        ...
        try {
            ...
            String link = AppSettings.getInstance(this).getPropertyValue("renual");
...
//        String usersession = AppPreferences.getInstance(this).getFromStore("email");
//        try {
//            emaildata = "email=" + URLEncoder.encode(usersession, "UTF-8");
//        } catch (UnsupportedEncodingException e) {
//            e.printStackTrace();
//        }
        //Map<String, String> map = new HashMap<String, String>();
        //map.put("email", AppPreferences.getInstance(this).getFromStore("email"));
        webview.loadUrl(url);
    }
