...
public class Golf_SubArea extends AppCompatActivity implements IItemHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // findViewById(R.id.view2).setVisibility(View.VISIBLE);
        ...
        ((TextView) findViewById(R.id.title_name)).setText("GOLF COURSES IN "+extras.getString("rname"));
    ...
    private void getData() {
        try {
            ...
            String url = AppSettings.getInstance(this).getPropertyValue("club_details");
            JSONObject object = new JSONObject();
           // object.put("stateid", extras.getString("stateid"));
            //object.put("locationid", extras.getString("locationid"));
                ...
                case 1:
                    if (results != null) {
                        ...
                        if (object.has("status") && object.optString("status").equalsIgnoreCase("0")) {
                            ...
                            adapter = new GolfAdapter(this, statesList);
