...
public class UpdateEmailAddress extends AppCompatActivity implements View.OnClickListener, IItemHandler {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.forget_password);
        ((TextView) findViewById(R.id.forgot_title)).setText("Update Email");
    ...
    private void updateMail() {
        ...
        try {
            ...
            String url = AppSettings.getInstance(this).getPropertyValue("updateemail");
            JSONObject object = new JSONObject();
            object.put("username", AppPreferences.getInstance(this).getFromStore("email"));
            object.put("newusername", email.trim());
            ...
            switch (requestType) {
                ...
                case 1:
                    ...
                    if (Object.has("status") && Object.optString("status").equalsIgnoreCase("0")) {
                        ...
                        AppPreferences.getInstance(this).addToStore("uemail", Object.optString("email"));
                        finish();
                    }
                    showToast(Object.optString("statusdescription"));
